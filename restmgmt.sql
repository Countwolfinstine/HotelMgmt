...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 12, 2017 at 01:00 PM
...
ALTER TABLE `currentorder`
  ...
  ADD CONSTRAINT `order_mapping` FOREIGN KEY (`order_id`) REFERENCES `orderlog` (`orderid`);
...
ALTER TABLE `order`
  ...
  ADD CONSTRAINT `order_ibfk_2` FOREIGN KEY (`orderid`) REFERENCES `orderlog` (`orderid`);
COMMIT;
